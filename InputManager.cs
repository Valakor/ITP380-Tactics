...
namespace itp380
{
	...
	public enum eBindings
	{
		UI_Exit = 0,
        CAMERA_ROTATE,
        CAMERA_CONTROL_FORWARD,
        CAMERA_CONTROL_BACKWARD,
        CAMERA_CONTROL_LEFT,
	...
	public class InputManager : itp380.Patterns.Singleton<InputManager>
	{
        ...
        private void InitializeBindings()
        {
            ...
            m_Bindings.Add(eBindings.CAMERA_CONTROL_BACKWARD, new BindInfo(Keys.S, eBindType.Held));
            m_Bindings.Add(eBindings.CAMERA_CONTROL_FORWARD, new BindInfo(Keys.W, eBindType.Held));
            m_Bindings.Add(eBindings.CAMERA_CONTROL_LEFT, new BindInfo(Keys.A, eBindType.Held));
            m_Bindings.Add(eBindings.CAMERA_CONTROL_RIGHT, new BindInfo(Keys.D, eBindType.Held));
            m_Bindings.Add(eBindings.CAMERA_ROTATE, new BindInfo(Keys.LeftShift, eBindType.Held));
            m_Bindings.Add(eBindings.CAMERA_ZOOM_OUT, new BindInfo(Keys.Q, eBindType.Held));
            m_Bindings.Add(eBindings.CAMERA_ZOOM_IN, new BindInfo(Keys.E, eBindType.Held));
        }
